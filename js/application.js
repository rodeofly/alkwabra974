...
(function() {
  var Card, Fraction, ability_to_delete_useless_card, addPower, animation_tap, animation_touch, astuces, beurk, block, blockOrNot, blocked, boolean_reset, chapter, checkSuccess, crossPower, delay, draggableCards, dropOnce, dropdenPower, dropnumPower, droppableFrac, droppableFracAddition, droppableFracSimplify, droppableSide, explosion_effect, flash_alert, game_chapter, get_card, insert, level, level_data, looping, multPower, negPower, opposite, play, primeFactorPower, primeFactorization, primePower, ready, reversePower, score, shots, shuffle_cards, stylePower, toSend_reset, unblock, unique_id, update_style, won, _ref, _ref1, _ref2, _ref3,
  ...
  _ref = [1, 1, 1], unique_id = _ref[0], chapter = _ref[1], level = _ref[2];
  ...
  ], level_data = _ref1[0], opposite = _ref1[1];

  _ref2 = [0, 0, 0], score = _ref2[0], shots = _ref2[1], beurk = _ref2[2];

  _ref3 = [true, false, false, false, false, false, false, false, false, false, false, false], dropOnce = _ref3[0], blocked = _ref3[1], reversePower = _ref3[2], dropdenPower = _ref3[3], dropnumPower = _ref3[4], stylePower = _ref3[5], crossPower = _ref3[6], addPower = _ref3[7], primePower = _ref3[8], multPower = _ref3[9], negPower = _ref3[10], won = _ref3[11];

  toSend_reset = function() {
    var _ref4;
    return _ref4 = [0, 0, 0], score = _ref4[0], shots = _ref4[1], beurk = _ref4[2], _ref4;
  };

  boolean_reset = function() {
    var _ref4;
    return _ref4 = [true, false, false, false, false, false, false, false, false, false, false, false], dropOnce = _ref4[0], blocked = _ref4[1], reversePower = _ref4[2], dropdenPower = _ref4[3], dropnumPower = _ref4[4], stylePower = _ref4[5], crossPower = _ref4[6], addPower = _ref4[7], primePower = _ref4[8], multPower = _ref4[9], negPower = _ref4[10], won = _ref4[11], _ref4;
  };
  ...
  Card = (function() {
    ...
    Card.prototype.moveTo = function(string) {
      this.string = string;
  ...
  Fraction = (function() {
    ...
    Fraction.prototype.to_html = function() {
      var d, fraction, i, n, _i, _j, _len, _len1, _ref4, _ref5, _ref6;
      _ref4 = ["", ""], n = _ref4[0], d = _ref4[1];
      _ref5 = this.numerateur;
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        i = _ref5[_i];
        n += (new Card(i)).to_html();
      }
      _ref6 = this.denominateur;
  ...
  shuffle_cards = function(container) {
    ...
    calc_overlap = function(a1) {
      var a2, i, intersection, overlap, x1, x2, y1, y2, _ref4, _ref5, _ref6;
      _ref4 = [0, 0], overlap = _ref4[0], i = _ref4[1];
      while (i < filled_areas.length) {
        a2 = filled_areas[i];
        if (!((a1.x + a1.width < a2.x) || (a2.x + a2.width < a1.x) || (a1.y + a1.height < a2.y) || (a2.y + a2.height < a1.y))) {
          _ref5 = [Math.max(a1.x, a2.x), Math.max(a1.y, a2.y)], x1 = _ref5[0], y1 = _ref5[1];
          _ref6 = [Math.min(a1.x + a1.width, a2.x + a2.width), Math.min(a1.y + a1.height, a2.y + a2.height)], x2 = _ref6[0], y2 = _ref6[1];
    ...
    randomize = function(container) {
      ...
      return container.children(".fraction").each(function() {
        var area, best_choice, i, overlap, rand_x, rand_y, smallest_overlap, _ref4, _ref5;
        _ref4 = [0, 9007199254740992], i = _ref4[0], smallest_overlap = _ref4[1];
        while (i++ < maxSearchIterations) {
          ...
          if (overlap < smallest_overlap) {
            _ref5 = [overlap, area], smallest_overlap = _ref5[0], best_choice = _ref5[1];
          }
          if (overlap === 0) {
            break;
          }
        ...
        if (xSide.find(".carte").length === 1) {
          ...
          return delay(5000, function() {
            ...
            count_beurk = function() {
              var clone_list, denominateur, i, item, item2, items_left, j, list, numerateur, split, value_side, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5;
              beurk = 0;
              items_left = {};
              list = [];
              value_side = opposite[xSide.attr("data-side")];
              $("#" + value_side).find(".fraction").each(function() {
                var denominateur, numerateur, string, _ref4;
                _ref4 = [[], []], numerateur = _ref4[0], denominateur = _ref4[1];
              ...
              while (clone_list.length > 0) {
                ...
                if (denominateur.length > 0) {
                  _ref4 = numerateur.split(".");
                  for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
                    i = _ref4[_i];
                    _ref5 = denominateur.split(".");
            ...
            return delay(1000, function() {
              var $div, i, img, previous_score, _i, _ref4;
              $("#stars").remove();
              $div = $("<div>", {
                id: "stars",
                "class": "reward"
              ...
              if (score > previous_score) {
                for (i = _i = 1, _ref4 = score - previous_score; 1 <= _ref4 ? _i <= _ref4 : _i >= _ref4; i = 1 <= _ref4 ? ++_i : --_i) {
              ...
              return $("#victory-recap").show().fireworks();
            });
          });
        }
      }
  ...
  flash_alert = function(element) {
    ...
    $("#wow-dialog").dialog({
      ...
      open: function(event, ui) {
        return setTimeout("$('#wow-dialog').dialog('close')", 1000);
      },
      position: {
        my: "center bottom",
        at: "center top",
  ...
  primeFactorPower = function() {
    return $("body").on("dblclick", ".fraction .carte:not(.fraction[data-side='pioche'])", function(event, ui) {
      var f, factors, next, prev, value, _i, _len;
      event.stopImmediatePropagation();
  ...
  droppableSide = function(side) {
    return $("#" + side).droppable({
      ...
      hoverClass: "shine-white",
      accept: function(draggable) {
        var side_draggable, _ref4;
        side_draggable = (_ref4 = draggable.attr("data-side")) != null ? _ref4 : "";
  ...
  draggableCards = function() {
    var multPowerSelector, side, _i, _len, _ref4;
  ...
  insert = function(data, sides) {
    var fraction, item, side, _i, _j, _len, _len1, _ref4;
    if (sides == null) {
      sides = [];
    }
    if (data['lhs'] != null) {
  ...
  animation_touch = function(element1, element2) {
    var boucle, clone, depart, destination, left, position, restart, top, _ref4;
    ...
    switch (element2) {
      ...
      case "rhs":
        ...
        _ref4 = [position.top + Math.round($("#" + element2).width() / 2), position.left + Math.round($("#" + element2).height() / 2)], top = _ref4[0], left = _ref4[1];
        destination = {
          top: top,
          left: left
        };
  ...
  play = function() {
    var i, _i, _len, _ref4, _ref5, _ref6;
    ...
    level_data.reveal = (_ref4 = level_data.reveal) != null ? _ref4 : [];
    if (__indexOf.call(level_data.reveal, "all") < 0) {
      _ref5 = level_data.reveal;
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        i = _ref5[_i];
    ...
    if ((_ref6 = "" + chapter + "-" + level) === "2-19" || _ref6 === "2-20" || _ref6 === "3-17" || _ref6 === "3-18" || _ref6 === "3-19" || _ref6 === "3-20" || _ref6 === "4-17" || _ref6 === "4-18" || _ref6 === "4-19" || _ref6 === "4-20" || _ref6 === "5-17" || _ref6 === "5-18" || _ref6 === "5-19" || _ref6 === "5-20") {
      stylePower = true;
    }
    if ((chapter > 3) || ((chapter > 3) && (level > 3))) {
      primeFactorPower();
  ...
  ready = function() {
    ...
    return $(".level").on("click", function() {
      var _ref5, _ref6;
      _ref5 = $(this).attr("id").split("-"), chapter = _ref5[0], level = _ref5[1];
      _ref6 = [parseInt(chapter), parseInt(level)], chapter = _ref6[0], level = _ref6[1];
