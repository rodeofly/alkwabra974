...
(function() {
  ...
  Card = (function() {
    ...
    Card.prototype.to_html = function() {
      var _ref;
      if ((__indexOf.call(level_data.reveal, "all") >= 0) || (_ref = this.string, __indexOf.call(level_data.reveal, _ref) >= 0) || ($.isNumeric(this.string) && (__indexOf.call(level_data.reveal, "numbers") >= 0))) {
    ...
    Card.prototype.moveTo = function(_at_string) {
      this.string = _at_string;
  ...
  Fraction = (function() {
    ...
    Fraction.prototype.to_html = function() {
      var d, fraction, i, n, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      _ref = ["", ""], n = _ref[0], d = _ref[1];
      _ref1 = this.numerateur;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        i = _ref1[_i];
        n += (new Card(i)).to_html();
      }
      _ref2 = this.denominateur;
  ...
  shuffle_cards = function(container) {
    ...
    calc_overlap = function(a1) {
      var a2, i, intersection, overlap, x1, x2, y1, y2, _ref;
      _ref = [0, 0], overlap = _ref[0], i = _ref[1];
    ...
    randomize = function(container) {
      ...
      return container.children(".fraction").each(function() {
        var area, best_choice, i, overlap, rand_x, rand_y, smallest_overlap, _ref, _ref1;
        _ref = [0, 9007199254740992], i = _ref[0], smallest_overlap = _ref[1];
        while (i++ < maxSearchIterations) {
          ...
          if (overlap < smallest_overlap) {
            _ref1 = [overlap, area], smallest_overlap = _ref1[0], best_choice = _ref1[1];
          }
          if (overlap === 0) {
            break;
          }
  ...
  primeFactorPower = function() {
    return $(".fraction .carte").not(".fraction[data-side='pioche']").on("dblclick", function() {
      var card, f, factors, value, _i, _len;
  ...
  droppableSide = function(side) {
    return $("#" + side).droppable({
      tolerance: 'touch',
      accept: function(draggable) {
        var side_draggable, _ref;
        side_draggable = (_ref = draggable.attr("data-side")) != null ? _ref : "";
  ...
  draggableCards = function() {
    ...
    $(".fraction .carte:not(:only-child)").not(".fraction[data-side='pioche'] .carte").on("click", function() {
      if ($(this).attr("data-valeur") === "1") {
        $(this).remove();
        return checkSuccess();
      }
    });
  ...
  insert = function(data, sides) {
    var fraction, item, side, _i, _j, _len, _len1, _ref;
    if (sides == null) {
      sides = [];
    }
    if (data['lhs'] != null) {
  ...
  play = function() {
    ...
    level_data.reveal = (_ref = level_data.reveal) != null ? _ref : [];
    if (__indexOf.call(level_data.reveal, "all") < 0) {
      _ref1 = level_data.reveal;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        i = _ref1[_i];
    ...
    insert(level_data);
    draggableCards();
    if ((_ref2 = chapter + "-" + level) === "1-1" || _ref2 === "1-3" || _ref2 === "1-9" || _ref2 === "1-16" || _ref2 === "2-1" || _ref2 === "2-5" || _ref2 === "2-11" || _ref2 === "3-1" || _ref2 === "3-7" || _ref2 === "4-1" || _ref2 === "4-4" || _ref2 === "5-1") {
  ...
  $(function() {
    var i, j, resize, _i, _j, _k, _len, _ref;
    $(".dialog").dialog({
      autoOpen: false
    });
    ...
    _ref = ["1-1", "1-3", "1-9", "1-16", "2-1", "2-5", "2-11", "3-1", "3-7", "4-1", "4-4", "5-1"];
    ...
    return $(".level").on("click", function() {
      var _ref1, _ref2;
      _ref1 = $(this).attr("id").split("-"), chapter = _ref1[0], level = _ref1[1];
      _ref2 = [parseInt(chapter), parseInt(level)], chapter = _ref2[0], level = _ref2[1];
