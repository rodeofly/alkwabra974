...
(function() {
  ...
  explosion_effect = function(position) {
    var id;
    ...
    $("#" + id).css({
      ...
      background: "url('./css/images/explosion.gif?" + (Math.random()) + "')"
    });
    return $("#" + id).hide(1000, function() {
      return $("#" + id).remove();
    });
  };
  ...
  block = function(draggable) {
    ...
    $(".carte").not(draggable.find(".carte")).on("click mousedown", function() {
    ...
    $(".DC").droppable({
      ...
      drop: function(event, ui) {
        ...
        $(this).after(clone.children(":first").children(":first").css({
          position: "relative"
        }).removeClass("pioche"));
        $(this).remove();
  ...
  fractionSimplify = function() {
    return $(".fraction .carte").not(".fraction[data-side='pioche'] .carte").droppable({
      ...
      drop: function(event, ui) {
        ...
        return explosion_effect($(this).offset());
      }
    });
  };
  ...
  primeFactorPower = function() {
    return $(".fraction .carte").not(".fraction[data-side='pioche']").on("dblclick", function(event, ui) {
      var f, factors, k, len, value;
  ...
  draggableCards = function() {
    ...
    $(".carte[data-valeur='0']").click(function(event, ui) {
      event.stopImmediatePropagation();
